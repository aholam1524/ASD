...
Rules:
- Look for bugs, missing tests, security issues, and scope creep.
- Comment on this pull request with findings. Use inline comments when a note belongs on a specific line.
